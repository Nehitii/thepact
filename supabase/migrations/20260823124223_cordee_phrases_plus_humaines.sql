...
-- LES PHRASES DE PROFIL SONNAIENT TOUTES PAREIL.
--
-- « Un pas, puis un autre. », « La constance avant la vitesse. »,
-- « Faire, pas dire. » : quinze maximes de la meme longueur, toutes
-- bien tournees, toutes ponctuees. C est precisement ce qui trahit une
-- liste ecrite d un coup — de vraies phrases de profil sont
-- IRREGULIERES.
--
-- Celles-ci le sont : certaines en minuscules, certaines sans point,
-- certaines qui ne veulent presque rien dire, une qui se plaint, deux
-- qui comptent les jours. Trois citations reelles et anciennes, du
-- domaine public, parce qu il s en trouve toujours sur un profil.
--
-- Le desordre n est pas un ornement : c est ce qui fait vrai.
