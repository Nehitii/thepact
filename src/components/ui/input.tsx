  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-11 w-full rounded-xl border-[1.5px] border-primary/50 bg-[hsl(210_80%_8%/0.9)] backdrop-blur-sm px-4 py-3 text-base text-[hsl(205_100%_90%)] transition-all duration-200 ease-out",
          ...
          "file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-[hsl(205_100%_90%)]",
