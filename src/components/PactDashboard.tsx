  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative group">
        ...
        <div className="relative bg-card/20 backdrop-blur-xl border-2 border-primary/30 rounded-lg scan-line overflow-hidden">
      ...
      <div className="relative group">
        <div className="absolute inset-0 bg-finance/5 rounded-lg blur-xl" />
        <div className="relative bg-card/20 backdrop-blur-xl border-2 border-finance/30 rounded-lg overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
