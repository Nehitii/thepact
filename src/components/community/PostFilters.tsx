...
const filterOptions: { 
  ...
  { value: 'all', label: 'All', dotColor: 'bg-primary', activeClasses: 'bg-primary/18 border-primary/40 text-violet-300 font-semibold' },
  { value: 'reflection', label: 'Reflections', dotColor: 'bg-blue-500', activeClasses: 'bg-blue-500/15 border-blue-500/40 text-blue-300 font-semibold' },
  { value: 'progress', label: 'Progress', dotColor: 'bg-amber-500', activeClasses: 'bg-amber-500/15 border-amber-500/40 text-amber-300 font-semibold' },
  { value: 'obstacle', label: 'Obstacles', dotColor: 'bg-rose-500', activeClasses: 'bg-rose-500/15 border-rose-500/40 text-rose-300 font-semibold' },
  { value: 'mindset', label: 'Mindset', dotColor: 'bg-violet-500', activeClasses: 'bg-violet-500/15 border-violet-500/40 text-violet-300 font-semibold' },
  { value: 'help_request', label: 'Help Needed', dotColor: 'bg-orange-500', activeClasses: 'bg-orange-500/15 border-orange-500/40 text-orange-300 font-semibold' },
  { value: 'encouragement', label: 'Support', dotColor: 'bg-emerald-500', activeClasses: 'bg-emerald-500/15 border-emerald-500/40 text-emerald-300 font-semibold' },
];
