...
export function ModuleHeader({ systemLabel, title, titleAccent, badges = [], children }: ModuleHeaderProps) {
  return (
    ...
    >
      ...
      {/* Title */}
      <h1 className="font-orbitron font-black text-[clamp(28px,5vw,48px)] tracking-[0.08em] leading-none mb-2 text-transparent bg-clip-text bg-gradient-to-b from-foreground/95 to-foreground/50">
