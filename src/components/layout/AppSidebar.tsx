  ...
  return (
    <aside
      className={cn(
        ...
        "bg-background/95 dark:bg-[#03060a]/95",
    ...
    >
      <style
        ...
        .no-scrollbar { 
          ...
          overflow-y: auto; /* Permet toujours le scroll interne sans l'afficher */
        }
      `,
        }}
      />
      ...
      {/* --- NAVIGATION --- */}
      <nav className="flex-1 px-3 space-y-2 no-scrollbar relative">
          ...
          <div className="pt-4">
            {!isCollapsed ? (
              <>
                ...
                <div
                  className={cn(
                    "space-y-1 transition-all duration-300 overflow-hidden border-l border-border ml-5",
        ...
        <div className="pt-2">
          {!isCollapsed ? (
            <>
              ...
              <div
                className={cn(
                  "space-y-1 transition-all duration-300 overflow-hidden border-l border-border ml-5 mt-1",
