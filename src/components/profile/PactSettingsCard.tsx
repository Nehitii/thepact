...
export function PactSettingsCard({
  ...
  return (
    <div className="relative group">
      ...
      {/* Main card */}
      <div className={cn(
        "relative backdrop-blur-xl border-2 border-primary/30 rounded-xl",
        "bg-card/40 transition-all duration-300 overflow-hidden",
        ...
        {/* Header */}
        <div className="relative z-10 p-5 border-b border-primary/20">
