  ...
  const statusBreakdown = (
    <div className="grid grid-cols-3 gap-2">
      <div className="text-center p-2 rounded-sm bg-[rgba(0,180,255,0.03)] border border-[rgba(0,180,255,0.08)]">
        <div className="ds-t-label font-orbitron uppercase tracking-wider text-[var(--nexus-text-dim)] mb-1">Not Started</div>
        <div className="text-base font-mono font-bold text-[var(--nexus-text-label)] tabular-nums">{data.statusCounts.not_started}</div>
      </div>
      <div className="text-center p-2 rounded-sm bg-[rgba(0,180,255,0.03)] border border-[rgba(0,180,255,0.08)]">
        <div className="ds-t-label font-orbitron uppercase tracking-wider text-primary/50 mb-1">In Progress</div>
      ...
      <div className="text-center p-2 rounded-sm bg-[rgba(0,255,136,0.02)] border border-[rgba(0,255,136,0.08)]">
        <div className="ds-t-label font-orbitron uppercase tracking-wider text-emerald-400/50 mb-1">Completed</div>
      ...
      <div className="flex items-center justify-center gap-6 flex-1">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <div className="ds-t-label text-[var(--nexus-text-dimmer)] font-orbitron uppercase tracking-wider">Overall</div>
          </div>
        </div>
        ...
        <div className="space-y-2.5">
          <div>
            <div className="flex items-center gap-2 mb-0.5">
              ...
              <span className="ds-t-label font-orbitron uppercase tracking-wider text-[var(--nexus-text-dim)]">Goals</span>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-0.5">
              ...
              <span className="ds-t-label font-orbitron uppercase tracking-wider text-[var(--nexus-text-dim)]">Steps</span>
            </div>
          ...
          {data.totalHabitChecks > 0 && (
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                ...
                <span className="ds-t-label font-orbitron uppercase tracking-wider text-[var(--nexus-text-dim)]">Habits</span>
              </div>
