      ...
      <div className="flex items-start gap-5" style={{ padding: "20px 24px 0" }}>
        ...
        <div className="relative shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-0.5">
            ...
            <span style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: "max(11px, 0.6875rem)", letterSpacing: 2, color: "rgba(0,212,255,0.8)", textTransform: "uppercase" as const }}>
              LEVEL
            </span>
          </div>
        </div>
        ...
        <div className="flex-1" style={{ paddingTop: 6 }}>
          <div
            ...
            style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: "max(11px, 0.6875rem)", letterSpacing: 3, color: "var(--nexus-text-dim)", textTransform: "uppercase" as const, marginBottom: 6 }}
          >
          ...
          <div style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: "max(11px, 0.6875rem)", color: "var(--nexus-text-dim)", letterSpacing: 2, lineHeight: 1.8 }}>
            RANG ACTUEL<br />
      ...
      <div style={{ padding: "0 24px 20px" }}>
        ...
        <div className="flex justify-between items-baseline" style={{ marginBottom: 10 }}>
          <div>
            ...
            <span style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: "max(11px, 0.6875rem)", color: "var(--nexus-text-dim)", letterSpacing: 2, marginLeft: 4 }}>
              XP
            </span>
          </div>
          <div className="text-right">
            <div style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: "max(11px, 0.6875rem)", color: "rgba(255,140,0,0.7)", letterSpacing: 1 }}>
        ...
        <div className="relative" style={{ marginBottom: 8 }}>
          ...
          >
            ...
            <span className="absolute" style={{ top: "50%", right: 8, transform: "translateY(-50%)", fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: "max(11px, 0.6875rem)", color: "var(--nexus-text-dim)", letterSpacing: 1 }}>
              {Math.round(progressInCurrentRank)}%
            </span>
          </div>
        </div>

        <div className="flex justify-between" style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: "max(11px, 0.6875rem)", color: "var(--nexus-text-dim)", letterSpacing: 1 }}>
          <span>0</span>
        ...
        {nextRank && (
          ...
          >
            ...
            <div style={{ paddingLeft: 10 }}>
              <div style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: "max(11px, 0.6875rem)", letterSpacing: 3, color: "var(--nexus-text-dim)", textTransform: "uppercase" as const, marginBottom: 3 }}>
                PROCHAIN RANG
              </div>
            ...
            <div style={{ fontFamily: "'JetBrains Mono', ui-monospace, monospace", fontSize: 13, color: "rgba(255,140,0,0.6)", letterSpacing: 2 }}>
