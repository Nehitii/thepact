    ...
    <div className="space-y-2">
      <div className="grid grid-cols-2 gap-2">
        <div className="p-2.5 rounded-sm bg-[rgba(0,180,255,0.03)] border border-[rgba(0,180,255,0.08)]">
          <div className="ds-t-label uppercase tracking-wider font-orbitron text-[var(--nexus-text-dim)] mb-1">
        ...
        {!isCustomMode && (
          <div className="p-2.5 rounded-sm bg-[rgba(0,180,255,0.03)] border border-[rgba(0,180,255,0.08)]">
            <div className="ds-t-label uppercase tracking-wider font-orbitron text-primary/40 mb-1">Paid / Financed</div>
      ...
      <div className="p-2.5 rounded-sm bg-[rgba(255,140,0,0.03)] border border-[rgba(255,140,0,0.1)]">
        <div className="ds-t-label uppercase tracking-wider font-orbitron text-amber-400/50 mb-1">Remaining</div>
    ...
    >
      <div className="flex-1 flex flex-col justify-center">
        <div className="text-center mb-3">
          <div className="ds-t-label uppercase tracking-wider font-orbitron text-[var(--nexus-text-dimmer)] mb-1">
            {isCustomMode ? 'Remaining' : 'Left to Finance'}
          </div>
          <div className="text-2xl font-mono font-bold text-primary tabular-nums">
            {formatCurrency(totalCostRemaining, currency)}
          </div>
          <div className="ds-t-label text-[var(--nexus-text-dimmer)] font-mono mt-0.5">
