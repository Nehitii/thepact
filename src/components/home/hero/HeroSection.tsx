...
export function HeroSection({ pact, focusGoals, allGoals, rankData, ownedModules, className }: HeroSectionProps) {
  ...
  return (
    <motion.section
      ...
      initial="hidden"
      animate="visible"
      className={cn("relative w-full max-w-7xl mx-auto px-4 sm:px-6 z-10 py-8", className)}
    >
      ...
      <div className="flex flex-col items-center space-y-8">
        {/* --- 1. IDENTITY BLOCK --- */}
        <motion.div variants={itemVariants} className="relative z-20 text-center w-full flex flex-col items-center">
          {/* Logo / Flame */}
          ...
          {/* Titre Projet */}
          <h1 className="text-4xl sm:text-6xl font-black font-orbitron tracking-tight text-white drop-shadow-[0_0_25px_rgba(255,255,255,0.2)] mb-3">
            {pact.name}
          </h1>

          {/* --- MANTRA RESTORED & STYLED --- */}
          {pact.mantra && (
        ...
        <motion.div variants={itemVariants} className="w-full max-w-2xl relative">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-black/60 backdrop-blur-md p-6 sm:p-8 shadow-2xl">
            ...
            <div className="flex items-end justify-between mb-5">
              <div className="flex flex-col gap-1.5">
                ...
                <CurrentRankBadge
                  ...
                  hideProgress={true}
                  className="items-start scale-110 origin-left"
                />
              </div>
            ...
            <div className="flex justify-between mt-2.5 text-[10px] font-mono text-white/30">
        ...
        {/* --- 4. DOCK ACTIONS (Sticky Bottom) --- */}
        <div className="h-2 sm:h-6" /> {/* Spacer */}
