        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <span className="ds-t-label font-orbitron font-bold uppercase tracking-[0.15em] text-primary">
                Pact Nexus
              </span>
              ...
              <div className="flex items-center gap-1.5">
                ...
                />
                <span className="ds-t-label font-orbitron uppercase tracking-[0.15em] text-muted-foreground/60">
            ...
            <div className="mt-0.5 h-4 overflow-hidden">
              <AnimatePresence mode="wait">
                {!scan.done ? (
                  ...
                  >
                    <span className="ds-t-label font-rajdhani text-muted-foreground/70 tracking-wider">
                      {insights.length > 0
            ...
            >
              <div className="px-3 pb-3 space-y-2">
                ...
                <div className="flex items-center justify-center gap-2 pt-1">
                  ...
                  <span className="ds-t-label font-orbitron uppercase tracking-[0.15em] text-muted-foreground/30">
                    Nexus Engine v1.0
                  </span>
                </div>
              </div>
