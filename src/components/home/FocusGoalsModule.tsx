        ...
        return (
          ...
          >
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="ds-t-label font-mono text-primary tabular-nums">{progressPercent}%</span>
            </div>
    ...
    >
      {goals.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center text-center py-4">
          ...
          <p className="ds-t-label text-[var(--nexus-text-dimmer)] mt-0.5 font-rajdhani">Star goals to see them here</p>
        </div>
      ) : (
              ...
              >
                <div className="flex">
                  ...
                  <div className="flex-1 p-2.5 flex flex-col justify-center min-w-0">
                    ...
                    <div className="flex items-center justify-between ds-t-label mb-1">
