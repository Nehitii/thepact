...
export function HealthDataExport() {
  ...
  const exportCSV = async () => {
    ...
    try {
      ...
      if (!data || data.length === 0) { toast.info(t("health.export.noData")); return; }
  ...
  return (
    <Button
      ...
      onClick={exportCSV}
      disabled={loading}
      className="border-muted text-muted-foreground hover:text-hud-phosphor hover:border-hud-phosphor/30 font-mono"
    >
