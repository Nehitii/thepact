...
export function HealthScoreCard({ score, trend, factors }: HealthScoreCardProps) {
  ...
  return (
    <HUDFrame className="p-8" variant="hero" scanLine active={score >= 80} glowColor={scoreGlow}>
      <div className="relative flex flex-col lg:flex-row items-center gap-8">
        ...
        <div className="relative flex-shrink-0 w-48 h-48">
          <svg className="w-full h-full" viewBox="0 0 200 200">
            ...
            <motion.circle
              cx="100" cy="100" r="60" fill="none" stroke={innerRingColor}
              strokeWidth="4" strokeLinecap="round" strokeDasharray={circumference60}
            ...
            <motion.circle
              cx="100" cy="100" r="72" fill="none" stroke="#3b82f6" strokeWidth="3" strokeLinecap="round"
        ...
        <div className="flex-1 text-center lg:text-left space-y-4">
          <div>
            <h2 className="text-2xl font-bold text-foreground mb-2">{t("health.scores.weeklyAverage")}</h2>
            ...
            <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
              {factors.map((factor, i) => (
                <motion.span
                  ...
                  className="px-3 py-1 text-xs font-medium font-mono uppercase tracking-wider bg-hud-phosphor/10 text-hud-phosphor border border-hud-phosphor/20 rounded-lg"
                >
          ...
          {factors.length === 0 && (
            <p className="text-muted-foreground/70 text-sm font-mono">{t("health.dailyCheckin")}</p>
          )}
