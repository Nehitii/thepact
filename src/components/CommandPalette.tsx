  ...
  return (
    <>
      ...
      <motion.div
        ...
        data-chrome="palette"
        className="dark fixed bottom-36 right-4 md:bottom-24 md:right-6 z-[999] pointer-events-auto flex items-center shadow-[0_0_20px_hsl(var(--primary)/0.15)] rounded-full bg-[#03060A]/85 backdrop-blur-md border border-primary/30 p-1 cursor-grab active:cursor-grabbing"
      >
        <div
