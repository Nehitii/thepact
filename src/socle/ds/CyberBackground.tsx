export const CyberBackground = () => {
  return (
    ...
    >
      ...
      <div
        className="cyber-orb absolute top-1/4 left-1/4 w-64 h-64 bg-primary/5 rounded-full blur-2xl animate-float"
        style={{ willChange: "transform" }}
      />
      <div
        className="cyber-orb absolute bottom-1/4 right-1/4 w-96 h-96 bg-accent/5 rounded-full blur-2xl animate-float"
