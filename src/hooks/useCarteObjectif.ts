...
import { getDifficultyIntensity, getDifficultyLabel, getStatusLabel } from "@/lib/goalConstants";

/** La palette du registre, en hexadecimal et en composantes. */
const TEINTES: Record<string, { couleur: string; rgb: string }> = {
...
const TEINTE_PAR_DEFAUT = { couleur: "#94a3b8", rgb: "148, 163, 184" };
