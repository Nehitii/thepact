...
import { CommunityPostCard } from "@/domaines/social/composants/CommunityPostCard";
import { PostFilters } from "@/domaines/social/composants/PostFilters";
import { NATURES, libelleNature, type NaturePost } from "@/domaines/social/logique/vocabulaire";
import { Pastille } from "@/domaines/social/composants/Pastille";
import { useCadres } from "@/domaines/social/hooks/useCadres";
import { ChoixObjectif } from "@/domaines/social/composants/ChoixObjectif";
import { ChoixEmoji } from "@/domaines/social/composants/ChoixEmoji";
import { ChoixGif } from "@/domaines/social/composants/ChoixGif";
import {
  deposerMedia, estUnTypeAccepte, estUneVideo, retirerMedia,
  POIDS_MAX, POIDS_MAX_VIDEO, TYPES_ACCEPTES, urlEstUneVideo,
} from "@/domaines/social/logique/communityMedia";
import {
  useCommunityPosts,
  useCreatePost,
  useFilEnDirect,
