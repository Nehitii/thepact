  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-2 animate-pulse">
        <div className="p-3 rounded-full bg-primary/10 border border-primary/30 shadow-[0_0_15px_hsl(var(--primary)/0.3)]">
          <Lock className="h-6 w-6 text-primary drop-shadow-[0_0_8px_hsl(var(--primary)/0.8)]" />
        </div>
