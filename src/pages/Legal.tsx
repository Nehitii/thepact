        ...
        <div className="max-w-2xl mx-auto p-6 space-y-6 relative z-10 pb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-[var(--surface-panel)] border border-[var(--border-card)] rounded-xl p-6 space-y-4">
                ...
                <div className="text-[var(--text-body)] font-rajdhani space-y-3 text-sm leading-relaxed">
                  ...
                  <p>
                    Any unauthorized reproduction, distribution, modification, reverse engineering, or reuse of any part
                    of the application, in whole or in part, is strictly prohibited without prior written consent.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-[var(--surface-panel)] border border-[var(--border-card)] rounded-xl p-6 space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-orbitron font-semibold text-[var(--text-heading)]">Terms of Service</h2>
                </div>
                <div className="text-[var(--text-body)] font-rajdhani space-y-4 text-sm leading-relaxed">
                  ...
                  <div>
                    ...
                    <p className="mt-2">
                      The Pact does not verify, validate, or endorse user-generated content. All actions,
                      interpretations, and decisions made using the application remain under your full responsibility.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-2">
                      Users who deliberately misuse the platform or attempt to bypass safeguards may be sanctioned
                  ...
                  <div>
                    ...
                    <p className="mt-2">
                      All information, projections, statistics, or insights provided by the application are
                      informational only. You remain fully responsible for your decisions and actions.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-[var(--surface-panel)] border border-[var(--border-card)] rounded-xl p-6 space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-orbitron font-semibold text-[var(--text-heading)]">Privacy & Data Protection</h2>
                </div>
                <div className="text-[var(--text-body)] font-rajdhani space-y-4 text-sm leading-relaxed">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="mt-2">
                      These actions can be performed through your Profile settings or by contacting support.
                    </p>
                  </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-[var(--surface-panel)] border border-[var(--border-card)] rounded-xl p-6 space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-orbitron font-semibold text-[var(--text-heading)]">Liability & Modifications</h2>
                </div>
                <div className="text-[var(--text-body)] font-rajdhani space-y-4 text-sm leading-relaxed">
                  <div>
          ...
          <div className="text-center pt-6 pb-4 space-y-2">
            <div className="text-xs text-[#6b9ec4]/60 font-rajdhani">Last updated: December 2025</div>
        ...
        <AlertDialogContent className="bg-[#0a1525]/95 backdrop-blur-xl border border-primary/20">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-[#a8c8e8] font-rajdhani space-y-2">
              ...
              <p className="text-[#ff6b6b]/80 font-medium">
                This action cannot be undone. All your data, goals, journal entries, and progress will be permanently
                removed.
              </p>
        ...
        <AlertDialogContent className="bg-[#0a1525]/95 backdrop-blur-xl border border-red-500/30">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-[#a8c8e8] font-rajdhani space-y-3">
              ...
              <p>
                To confirm deletion, type <span className="text-white font-bold">DELETE</span> below:
              </p>
              <Input
                value={confirmText}
