...
function SectionHeader({ icon: Icon, title, color }: { icon: any; title: string; color: string }) {
  return (
    <div className="flex items-center gap-3 mb-4 mt-10 first:mt-0">
      ...
      <h2 className="text-lg font-orbitron font-bold text-foreground tracking-wide">{title}</h2>
    </div>
  );
}
...
export default function Analytics() {
  ...
  return (
    <div className="min-h-screen max-w-5xl mx-auto px-4 pb-16">
      ...
      {/* ═══════════════════════════════════════════════════════════════════════ */}
      {/* SECTION 1: PACT & GOALS */}
      {/* ═══════════════════════════════════════════════════════════════════════ */}
      <SectionHeader icon={Flame} title="Pact & Goals" color="bg-primary/20" />
      ...
      {/* SECTION 2: MODULES */}
      {/* ═══════════════════════════════════════════════════════════════════════ */}
      <SectionHeader icon={BarChart3} title="Modules Performance" color="bg-accent/20" />
