            ...
            >
              {exportOptions.map((option) => (
                <Label
                  ...
                  className={
                    "relative flex flex-col gap-2 p-4 rounded-lg cursor-pointer transition-all duration-200 border-2 " +
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={
                        "text-sm font-orbitron uppercase tracking-wide " +
                        (exportCategory === option.value ? "text-primary" : "text-primary/70")
                      }
                    >
                      {option.label}
                    </span>
                    <span className={"ml-auto " + (exportCategory === option.value ? "text-primary" : "text-primary/60")}>
                      {option.icon}
                    </span>
                  </div>
                  <span className="text-xs text-muted-foreground font-rajdhani pl-6">{option.description}</span>
                </Label>
              ))}
            </RadioGroup>
            <Button
