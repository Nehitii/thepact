  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <motion.div 
        ...
        style={{
          background: 'radial-gradient(ellipse at center, hsla(200,100%,60%,0.04) 0%, transparent 60%)',
        }}
        animate={{
          opacity: [0.5, 0.7, 0.5],
        }}
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mt-8">
          ...
          >
            <TabsList className="w-full max-w-xl neu-card p-2 mb-10 border-0">
              <TabsTrigger
                value="overview"
                className="flex-1 data-[state=active]:bg-white/[0.08] data-[state=active]:text-white data-[state=active]:shadow-[0_0_20px_hsla(200,100%,60%,0.15)] text-slate-400 font-semibold text-sm rounded-xl transition-all duration-300 py-3"
              >
          ...
          {/* Monthly Tab - PREMIUM NEUMORPHIC DESIGN */}
