...
export const routeImports = {
  ...
  analytics: () => import("@/domaines/analytique/pages/Analytics"),
  achievements: () => import("@/domaines/succes/pages/Achievements"),
  shop: () => import("@/domaines/boutique/pages/Shop"),
  profile: () => import("@/domaines/profil/pages/Profile"),
  boundedProfile: () => import("@/domaines/profil/pages/BoundedProfile"),
  pactSettings: () => import("@/domaines/profil/pages/PactSettings"),
  displaySound: () => import("@/domaines/profil/pages/DisplaySound"),
  privacyControl: () => import("@/domaines/profil/pages/PrivacyControl"),
  notificationSettings: () => import("@/domaines/profil/pages/NotificationSettings"),
  dataPortability: () => import("@/domaines/profil/pages/DataPortability"),
